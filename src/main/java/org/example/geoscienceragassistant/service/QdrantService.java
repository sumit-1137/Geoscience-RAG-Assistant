...
// =====================================================
// DELETE CHUNK VECTORS FROM QDRANT
// =====================================================

public void deleteChunks(List<DocumentChunk> chunks) {

    if (chunks == null || chunks.isEmpty()) {

        System.out.println(
                "No Qdrant vectors to delete."
        );
    ...
    try {
        ...
        System.err.println(
                "Failed to delete chunk vectors from Qdrant."
        );
